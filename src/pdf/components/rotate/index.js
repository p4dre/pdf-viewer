...
var RotateButton = function (_a) {
  ...
  var label = direction === RotateDirection.Backward ? backwardLabel : forwardLabel;
  var icon = direction === RotateDirection.Backward ? createElement(RotateBackwardIcon, null) : createElement(RotateForwardIcon, null);
  return createElement(Tooltip, {
    ariaControlsSuffix: "rotate",
    position: Position.BottomCenter,
    target: createElement(MinimalButton, { ariaLabel: label, testId: direction === RotateDirection.Backward ? "rotate__backward-button" : "rotate__forward-button", onClick: onClick }, icon),
    content: function () {
      return label;
    },
...
var RotateMenuItem = function (_a) {
  ...
  var label = direction === RotateDirection.Backward ? backwardLabel : forwardLabel;
  var icon = direction === RotateDirection.Backward ? createElement(RotateBackwardIcon, null) : createElement(RotateForwardIcon, null);
  return createElement(MenuItem, { icon: icon, testId: direction === RotateDirection.Backward ? "rotate__backward-menu" : "rotate__forward-menu", onClick: onClick }, label);
};
...
var useRotatePlugin = function () {
  ...
  var RotateBackwardButtonDecorator = function () {
    return createElement(RotateDecorator, { direction: RotateDirection.Backward }, function (props) {
      return createElement(RotateButton, __assign({}, props));
    });
  };
  var RotateBackwardMenuItemDecorator = function (props) {
    return createElement(RotateDecorator, { direction: RotateDirection.Backward }, function (p) {
  ...
  var RotateForwardButtonDecorator = function () {
    return createElement(RotateDecorator, { direction: RotateDirection.Forward }, function (props) {
      return createElement(RotateButton, __assign({}, props));
    });
  };
  var RotateForwardMenuItemDecorator = function (props) {
    return createElement(RotateDecorator, { direction: RotateDirection.Forward }, function (p) {
      return createElement(RotateMenuItem, {
        direction: p.direction,
        onClick: function () {
          p.onClick();
