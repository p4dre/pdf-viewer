...
var LazyRender = function (_a) {
  ...
  return createElement("div", __assign({ ref: containerRef }, containerAttrs), visible && children);
};
...
var CheckIcon = function () {
  return createElement(Icon, { size: 16 }, createElement("path", { d: "M23.5,0.499l-16.5,23l-6.5-6.5" }));
};
...
var MenuItem = function (_a) {
  ...
  return createElement(
    ...
    createElement(
      ...
      checked && createElement(CheckIcon, null)
    )
  );
};
...
var Separator = function () {
  return createElement("div", { className: "rpv-core__separator" });
};
...
var ModalOverlay = function (_a) {
  var children = _a.children;
  return createElement("div", { className: "rpv-core__modal-overlay" }, children);
};
...
var Portal = function (_a) {
  ...
  var _c = useToggle(isOpened),
    opened = _c.opened,
    toggle = _c.toggle;
  return createElement(Fragment, null, target && target(toggle, opened), opened && content(toggle));
};
...
var PopoverBody = function (_a) {
  ...
  return createElement(
    ...
    createElement(
      ...
      createElement("div", { id: innerId, ref: innerRef }, children)
    )
  );
};
...
var TooltipBody = function (_a) {
  ...
  return createElement(
    ...
    createElement(
      ...
      createElement("div", { className: "rpv-core__tooltip-body-content" }, children)
    )
  );
};
...
var useTogglePopup = function () {
  var _a = useToggle(false),
    opened = _a.opened,
    toggle = _a.toggle;
  var _b = useState(TogglePopupBy.Hover),
    togglePopupBy = _b[0],
...
var HelpIcon = function () {
  return createElement(
    ...
    createElement("path", { d: "M21.423 5.406L17.415 9.414" }),
    createElement("path", { d: "M14.587 6.585L18.607 2.565" }),
    createElement("path", { d: "M5.405 21.424L9.413 17.416" }),
    createElement("path", { d: "M6.585 14.588L2.577 18.596" }),
    createElement("path", { d: "M18.602 21.419L14.595 17.412" }),
    createElement("path", { d: "M17.419 14.58L21.428 18.589" }),
    createElement("path", { d: "M2.582 5.399L6.588 9.406" }),
    createElement("path", { d: "M9.421 6.581L5.412 2.572" })
  );
};
...
var NoteIcon = function () {
  return createElement(
    ...
    createElement("path", { d: "M6 4.5L6 0.5" }),
    createElement("path", { d: "M18 4.5L18 0.5" }),
    createElement("path", { d: "M10 4.5L10 0.5" }),
    createElement("path", { d: "M14 4.5L14 0.5" })
  );
};

var ParagraphIcon = function () {
  return createElement(Icon, { size: 16 }, createElement("path", { d: "M17.5 0.498L17.5 23.498" }), createElement("path", { d: "M10.5 0.498L10.5 23.498" }), createElement("path", { d: "M23.5.5H6.5a6,6,0,0,0,0,12h4" }));
};

var TriangleIcon = function () {
  return createElement(Icon, { size: 16 }, createElement("path", { d: "M2.5 22.995L12 6.005 21.5 22.995 2.5 22.995z" }));
};
        ...
        createElement(
          ...
          name &&
            createElement(
              ...
              name === "check" && createElement(CheckIcon, null),
              name === "comment" && createElement(CommentIcon, null),
              name === "help" && createElement(HelpIcon, null),
              name === "insert" && createElement(TriangleIcon, null),
              name === "key" && createElement(KeyIcon, null),
              name === "note" && createElement(NoteIcon, null),
              (name === "newparagraph" || name === "paragraph") && createElement(ParagraphIcon, null)
            ),
          props.slot.children
        ),
        childAnnotation &&
...
var useScroll = function (_a) {
  ...
  var _b = useState(ZERO_OFFSET$6),
    scrollOffset = _b[0],
    setScrollOffset = _b[1];
  var _c = useState(elementRef.current),
    element = _c[0],
    setElement = _c[1];
  var factor = isRtl ? -1 : 1;
  var latestRef = useRef(scrollDirection);
  latestRef.current = scrollDirection;
  var latestOffsetRef = useRef(ZERO_OFFSET$6);
  var isSmoothScrollingDoneRef = useRef(true);
  var handleSmoothScrollingComplete = useCallback(function () {
...
var useVirtual = function (_a) {
  ...
  var onSmoothScroll = useCallback(function (isSmoothScrolling) {
...
var useFullScreen = function (_a) {
  var getCurrentPage = _a.getCurrentPage,
    ...
    targetRef = _a.targetRef;
  var _b = useState(FullScreenMode.Normal),
    fullScreenMode = _b[0],
    setFullScreenMode = _b[1];
  var windowRect = useWindowResize();
  var _c = useState(ZERO_RECT),
    targetRect = _c[0],
    setTargetRect = _c[1];
  var windowSizeBeforeFullScreenRef = useRef(ZERO_RECT);
  var targetPageRef = useRef(getCurrentPage());
  var fullScreenSizeRef = useRef(ZERO_RECT);
  var _d = useState(targetRef.current),
    element = _d[0],
    setElement = _d[1];
  var fullScreenElementRef = useRef();
  useIsomorphicLayoutEffect(function () {
  ...
  var closeOtherFullScreen = useCallback(function (target) {
  ...
  var handleFullScreenChange = useCallback(
    function () {
      if (!element) {
        return;
      }
...
const Inner = (props) => {
  ...
  var renderViewer = useCallback(
    function () {
      ...
      // if (defaultLayoutPluginInstance.renderViewer) {
...
var AskingPassword = function (_a) {
  ...
  return createElement(
    ...
    createElement(
      ...
      createElement("div", { className: "rpv-core__asking-password-message" }, passwordStatus === PasswordStatus.RequiredPassword && l10n.core.askingPassword.requirePasswordToOpen, passwordStatus === PasswordStatus.WrongPassword && l10n.core.wrongPassword.tryAgain),
      createElement(
        "div",
        ...
        createElement(PrimaryButton, { onClick: submit }, l10n.core.askingPassword.submit)
      )
    )
  );
};
...
var DocumentLoader = function (_a) {
  ...
  var direction = useContext(ThemeContext).direction;
  var isRtl = direction === TextDirection.RightToLeft;
  var _b = useState(new LoadingState(0)),
    status = _b[0],
    setStatus = _b[1];
  var docRef = useRef("");
  var isMounted = useIsMounted();
  useEffect(
    function () {
      ...
      var worker = new PdfJsApi.PDFWorker({
      ...
      var loadingTask = PdfJsApi.getDocument(transformParams);
  ...
  if (status instanceof AskForPasswordState) {
    return createElement(AskingPassword, {
  ...
  if (status instanceof FailureState) {
    return renderError
      ...
      : createElement(
          ...
          createElement("div", { className: "rpv-core__doc-error-text" }, status.error.message)
        );
  }
  return createElement(
    "div",
    ...
    renderLoader ? renderLoader(status.percentages) : createElement(Spinner, null)
  );
};
...
var useWithTheme = function (theme, onSwitchTheme) {
